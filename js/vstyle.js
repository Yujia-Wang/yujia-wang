$(document).ready(function() {
    ...
    var gender = 1;
    var skincolor = 1;
    var clothing_category = "tanktop";
    var clothing_pattern = "solid";
    var neckline_shape = "folded";
    var clothing_color = "black";
    var hat = 0;
    var glasses = 0;
    var scarf = 0;
    var necktie = 0;
    ...
    $(".male-icon").click(function() {
        ...
        $(".dress-icon").addClass("disable");
        
        $(this).siblings().removeClass("icon-active");
        $(this).addClass("icon-active");
        
        if (clothing_category == "dress") {
            clothing_category = "tanktop";
            
            $(".tanktop-icon").addClass("icon-active");
            $(".dress-icon").removeClass("icon-active");
        }
    ...
    $(".female-icon").click(function() {
        ...
        $(".dress-icon").removeClass("disable");
    ...
    $(".tshirt-icon").click(function() {
        clothing_category = "tshirt";
    ...
    $(".folded-icon").click(function() {
        neckline_shape = "folded";
    ...
    $(".vshape-icon").click(function() {
        neckline_shape = "vshape";
    ...
    $(".colorful-icon").click(function() {
        clothing_color = "colorful";
    ...
    glyph = d3.select("#glyph");
    
    var head = glyph.append("div")
        .attr("class", "head head-position");
        
    var upperbody = glyph.append("div")
        .attr("class", "upperbody upperbody-position");
        
    
    var downbody = glyph.append("div")
        .attr("class", "downbody downbody-position");
    
    var clothing = glyph.append("div")
        .attr("class", "clothing");
    
    var neckline = glyph.append("div")
        .attr("class", "neckline");
    
    var accessory_hat = glyph.append("div")
        .attr("class", "accessory_hat");
    
    var accessory_glasses = glyph.append("div")
        .attr("class", "accessory_glasses");
    
    var accessory_necktie = glyph.append("div")
        .attr("class", "accessory_necktie");
    
    var accessory_scarf = glyph.append("div")
        .attr("class", "accessory_scarf");
    ...
    function updateGlyph() {
        ...
        d3.select(".clothing")
            .html(function() {
                if (clothing_category == "tanktop") {
                    d3.select(this)
                        .attr("class", "clothing tanktop-position");
                    
                    return tanktopHTML;
                }
                else if (clothing_category == "tshirt") {
                    d3.select(this)
                        .attr("class", "clothing tshirt-position");
                    
                    return tshirtHTML;
                }
                else if (clothing_category == "shirt") {
                    d3.select(this)
                        .attr("class", "clothing shirt-position");
                    
                    return shirtHTML;
                }
                else if (clothing_category == "sweater") {
                    d3.select(this)
                        .attr("class", "clothing sweater-position");
                    
                    return sweaterHTML;
                }
                else if (clothing_category == "suit") {
                    d3.select(this)
                        .attr("class", "clothing suit-position");
                    
                    return suitHTML;
                }
                else if (clothing_category == "outerwear") {
                    d3.select(this)
                        .attr("class", "clothing outerwear-position");
                    
                    return outerwearHTML;
                }
                else if (clothing_category == "dress") {
                    d3.select(this)
                        .attr("class", "clothing dress-position");
                    
                    return dressHTML;
                }
            });
        
        d3.select(".clothing svg")
            .attr("fill", function() {
                if (clothing_pattern == "solid") {
                    return "none";
                }
                else if (clothing_pattern == "graphics") {
                    return "url(#graphicsPattern)";
                }
                else if (clothing_pattern == "floral") {
                    return "url(#floralPattern)";
                }
                else if (clothing_pattern == "plaid") {
                    return "url(#plaidPattern)";
                }
                else if (clothing_pattern == "spotted") {
                    return "url(#spottedPattern)";
                }
                else if (clothing_pattern == "striped") {
        ...
        d3.select(".neckline")
            .html(function() {
                if (neckline_shape == "folded") {
                    d3.select(this)
                        .attr("class", "neckline folded-position");
                    
                    return foldedHTML;
                }
                else if (neckline_shape == "round") {
                    d3.select(this)
                        .attr("class", "neckline round-position");
                    
                    return roundHTML;
                }
                else if (neckline_shape == "vshape") {
                    d3.select(this)
                        .attr("class", "neckline vshape-position");
        ...
        d3.select(".left")
            .style("fill", function() {
                ...
                else if (clothing_color == "black") {
                    return colors_left.Black;
                }
                else if (clothing_color == "pink") {
                    return colors_left.Pink;
                }
                else if (clothing_color == "blue") {
                    return colors_left.Blue;
                }
                else if (clothing_color == "red") {
                    return colors_left.Red;
                }
                else if (clothing_color == "cyan") {
                    return colors_left.Cyan;
                }
                else if (clothing_color == "green") {
                    return colors_left.Green;
                }
                else if (clothing_color == "gray") {
                    return colors_left.Gray;
                }
                else if (clothing_color == "yellow") {
                    return colors_left.Yellow;
                }
                else if (clothing_color == "brown") {
                    return colors_left.Brown;
                }
                else if (clothing_color == "purple") {
                    return colors_left.Purple;
                }
                else if (clothing_color == "orange") {
                    return colors_left.Orange;
                }
                else if (clothing_color == "colorful") {
                    return colors_left.Colorful;
                }
            });
        ...
        d3.select(".right")
            .style("fill", function() {
                if (clothing_color == "white") {
                    ...
                    return colors_right.Colorful;
                }
            });
        
        d3.select(".accessory_hat")
            .html(function() {
                if (gender == 1) {
                    d3.select(this)
                        .attr("class", "accessory_hat malehat-position");

                    return maleHatHTML;
                }
                else {
                    d3.select(this)
                        .attr("class", "accessory_hat femalehat-position");
        ...
        d3.select(".accessory_glasses")
            .html(function() {
                if (gender == 1) {
                    d3.select(this)
                        .attr("class", "accessory_glasses maleglasses-position");

                    return maleGlassesHTML;
                }
                else {
                    d3.select(this)
                        .attr("class", "accessory_glasses femaleglasses-position");
        ...
        d3.select(".accessory_scarf")
            .html(function() {
                d3.select(this)
                    .attr("class", "accessory_scarf scarf-position");
        ...
        d3.select(".accessory_necktie")
            .html(function() {
                d3.select(this)
                    .attr("class", "accessory_necktie necktie-position");
        ...
        d3.selectAll(".head svg")
            .attr("width", function() {
                ...
                return headSize.width * 1.1;
            })
            .attr("height", function() {
                var headSize = d3.select(this).node().getBBox();
                return headSize.height * 1.1;
            })
        ...
        d3.selectAll(".head")
            .style("width", function() {
                ...
                return headSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var headSize = d3.select(this).selectAll("*").node().getBBox();
                return headSize.height * 1.1 + "px";
            });
        
        d3.selectAll(".upperbody svg")
            .attr("width", function() {
                var upperbodySize = d3.select(this).node().getBBox();
                return upperbodySize.width * 1.1;
            })
            .attr("height", function() {
                var upperbodySize = d3.select(this).node().getBBox();
                return upperbodySize.height * 1.1;
            })
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
        ...
        d3.selectAll(".upperbody")
            .style("width", function() {
                ...
                return upperbodySize.width * 1.1 + "px";
            })
            .style("height", function() {
                var upperbodySize = d3.select(this).selectAll("*").node().getBBox();
                return upperbodySize.height * 1.1 + "px";
            });

        d3.selectAll(".downbody svg")
            .attr("width", function() {
                var downbodySize = d3.select(this).node().getBBox();
                return downbodySize.width * 1.1;
            })
            .attr("height", function() {
                var downbodySize = d3.select(this).node().getBBox();
                return downbodySize.height * 1.1;
            })
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
        ...
        d3.selectAll(".downbody")
            .style("width", function() {
                ...
                return downbodySize.width * 1.1 + "px";
            })
            .style("height", function() {
                var downbodySize = d3.select(this).selectAll("*").node().getBBox();
                return downbodySize.height * 1.1 + "px";
            });
        
        var clothingSize = d3.select(".clothing svg").node().getBBox();

        d3.selectAll(".clothing svg")
            .attr("width", clothingSize.width * 1.1)
            .attr("height", clothingSize.height * 1.1)
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
            });
        
        d3.selectAll(".clothing")
            .style("width", function() {
                var clothingSize = d3.select(this).selectAll("*").node().getBBox();
                return clothingSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var clothingSize = d3.select(this).selectAll("*").node().getBBox();
                return clothingSize.height * 1.1 + "px";
            });
        
        var necklineSize = d3.select(".neckline svg").node().getBBox();

        d3.selectAll(".neckline svg")
            .attr("width", necklineSize.width * 1.1)
            .attr("height", necklineSize.height * 1.1)
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
            });
        
        d3.selectAll(".neckline")
            .style("width", function() {
                var necklineSize = d3.select(this).selectAll("*").node().getBBox();
                return necklineSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var necklineSize = d3.select(this).selectAll("*").node().getBBox();
                return necklineSize.height * 1.1 + "px";
            });

        d3.selectAll(".accessory_hat svg")
            .attr("width", function() {
                var hatSize = d3.select(this).node().getBBox();
                return hatSize.width * 1.1;
            })
            .attr("height", function() {
                var hatSize = d3.select(this).node().getBBox();
                return hatSize.height * 1.1;
            })
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
        ...
        d3.selectAll(".accessory_hat")
            .style("width", function() {
                var hatSize = d3.select(this).selectAll("*").node().getBBox();
                return hatSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var hatSize = d3.select(this).selectAll("*").node().getBBox();
                return hatSize.height * 1.1 + "px";
            });
        
        d3.selectAll(".accessory_glasses svg")
            .attr("width", function() {
                var glassesSize = d3.select(this).node().getBBox();
                return glassesSize.width * 1.1;
            })
            .attr("height", function() {
                var glassesSize = d3.select(this).node().getBBox();
                return glassesSize.height * 1.1;
            })
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
        ...
        d3.selectAll(".accessory_glasses")
            .style("width", function() {
                var glassesSize = d3.select(this).selectAll("*").node().getBBox();
                return glassesSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var glassesSize = d3.select(this).selectAll("*").node().getBBox();
                return glassesSize.height * 1.1 + "px";
            });
        
        var scarfSize = d3.select(".accessory_scarf svg").node().getBBox();

        d3.selectAll(".accessory_scarf svg")
            .attr("width", scarfSize.width * 1.1)
            .attr("height", scarfSize.height * 1.1)
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
            });
        
        d3.selectAll(".accessory_scarf")
            .style("width", function() {
                var scarfSize = d3.select(this).selectAll("*").node().getBBox();
                return scarfSize.width * 1.1 + "px";
            })
            .style("height", function(d) {
                var scarfSize = d3.select(this).selectAll("*").node().getBBox();
                return scarfSize.height * 1.1 + "px";
            });

        var necktieSize = d3.select(".accessory_necktie svg").node().getBBox();

        d3.selectAll(".accessory_necktie svg")
            .attr("width", necktieSize.width * 1.1)
            .attr("height", necktieSize.height * 1.1)
            .attr("viewBox", function() {
                var headSize = d3.select(this).node().getBBox();
                return "0 0 " + headSize.width + " " + headSize.height;
            });
        
        d3.selectAll(".accessory_necktie")
            .style("width", function() {
                var necktieSize = d3.select(this).selectAll("*").node().getBBox();
                return necktieSize.width * 1.1 + "px";
            })
            .style("height", function() {
                var necktieSize = d3.select(this).selectAll("*").node().getBBox();
                return necktieSize.height * 1.1 + "px";
            });     
    }
});